	...
	<body>
		...
		<table border="0" align="center" width="1100px">
				...
				<tr style="height:50px">
					<td><a href="myPage1.jsp"><u>게시물 목록보기</u></a></td>
					<td><a href="modify.jsp"><u>회원정보 수정</u></a></td>
				</tr>
				<tr>
				...
				<tr style="height:50px">
					<td><a href="myPage2.jsp"><u>댓글 쓴 게시물 목록 보기</u></a></td>
					<td><a href="deleteID.jsp"><u>회원탈퇴</u></a></td>
				</tr>
			</table>
		<br>
		<br>
