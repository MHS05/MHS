...
<script>
	...
	<form type="post" action="loginok.jsp">
		<table width="360px" align="center" border="0" style="margin-top: 20px">
			...
			<tr height="30px">
				<td colspan="2" align="center">
					<a href="../admin/member.jsp" target="_blank" onclick="window.close()">관리자로그인</a>
				</td>
			</tr>
			<tr>
				<td	align="center" colspan="2">
			...
			<tr height="50px">
				<td	align="center" colspan="2">
					<a href="../main/index2.jsp" target="_blank"><span onclick="window.close()">로그인</span></a>
