			...
			<tr>
				<td>
					<table border="0" align="center" width="400px" height="200px" style="background-color:#EDEDED">
						<tr>
							<td colspan="2" align="center" style="font-size:23px">탈퇴가 완료되었습니다.<br>이용해주셔서 감사합니다.</td>
						</tr>
						<tr>
							<td align="center">
							 	<a href="../main/index.jsp">
							 		<input type="button" value="확인" style="width:300px; height:50px; font-size:17px; background-color:#4dd5b0";>
							 	</a>
							</td>
						</tr>
					</table>
