		...
		<table border="0" align="center" width="1200px" >
			<tr>
				...
				<td rowspan="3" valign="top">
					...
					<div class="admin">
						<a href="adminreport.jsp"><h2>홍길동님의 신고 내역</h2></a>
					</div>
					<div class="community">
					<table border="0" width="100%" style="margin-top: 10px">
					<tr>
						<td width="120px" align="center">
							<a href="userclist.jsp" style="font-size:25px;font-weight: bold;">작성글</a>
						</td>
						<td height="30px" valign="bottom" width="100px">
							<select name="board" style="width: 100px; height: 40px;" >
								<option value="1">전체</option>
								<option value="2">자유게시판</option>
								<option value="3">태양인게시판</option>
								<option value="4">태음인게시판</option>
								<option value="5">소양인게시판</option>
								<option value="6">소음인게시판</option>
							</select>
						</td>
						<td>
							<a href="userclist.jsp">
							<img src="../image/설정.png" style="width: 20px; height: 20px;"></a>
						</td>
						<td align="right" valign="bottom">
							<a href="adminreport.jsp"><div class="dbutton">선택삭제</div></a>
						</td>
						<td height="30px" valign="bottom" align="right" width="100px">
							<select name="re" style="width: 100px; height: 30px">
								<option value="A">신고여부</option>
								<option value="B">조회수낮</option>
								<option value="C">최근순</option>
								<option value="D">오래된순</option>
							</select>
						</td>
					</tr>
					</table>
					...
					<tr>
						...
						<td align="center" width="150px">신고사유</td>
					</tr>
					<tr>
						<td colspan="6"><hr></td>
					</tr>
					<tr>
						...
						<td align="center">태양인게시판</td>
						<td align="center"><a href="adminCview.jsp">1번째 제목입니다.</a></td>
						<td align="center">2023.11.30</td>
						<td align="center">사유1</td>
					</tr>
					<tr>
						<td colspan="6"><hr></td>
					</tr>
					...
					<tr>
						<td width="120px" align="center">
							<a href="userRlist.jsp" style="font-size:25px;font-weight: bold;">작성댓글</a>
						</td>
						<td valign="middle">
							<a href="adminclist.jsp">
							<img src="../image/설정.png" style="width: 20px; height: 20px;"></a>
						</td>
						<td align="right" valign="bottom">
							<a href="adminreport.jsp"><div class="dbutton">선택삭제</div></a>
					...
					<tr>
						...
						<td align="center">1</td>
						<td align="center">태양인게시판</td>
						<td align="center"><a href="adminCview.jsp">1번째 댓글 내용입니다.</a></td>
						<td align="center">2023.11.30</td>
						<td align="center">사유1</td>
					</tr>
					<tr>
