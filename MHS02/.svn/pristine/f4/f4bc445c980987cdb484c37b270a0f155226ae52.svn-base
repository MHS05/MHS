	...
	<style>
		...
		<form>
			...
			<table border="0" width="1200px" align="center" style="margin-top: 10px">
				...
				<tr>
					<td width="180px" height="50px">아이디*</td>
					<td>hong</td>
					<td width="350px"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<input type="text" value="새로운 닉네임을 입력해주세요" style="width:250px; height:25px">
					</td>
					<td>
						</a><input type="button" value="닉네임 중복확인" style="height:30px; font-size:15px">
					</td>
				</tr>
				<tr>
