		...
		<table border="0" width="1200px" align="center">
			...
			<tr height="50px">
				...
				<tr height="30px">
					...
					<a class="month" href="select.jsp"><b>전체</b></a>&emsp;&emsp;
					<a class="month" href="select.jsp">굴</a>&emsp;&emsp;
					<a class="month" href="select.jsp">사과</a>&emsp;&emsp;
					<a class="month" href="select.jsp">홍합</a>&emsp;&emsp;
					<a class="month" href="select.jsp">꼬막</a>&emsp;&emsp;
					<a class="month" href="select.jsp">배추</a>&emsp;&emsp;
					<a class="month" href="select.jsp">무</a>&emsp;&emsp;
					<a class="month" href="select.jsp">대하</a>&emsp;&emsp;
